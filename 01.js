...
fetch( URLandKey ).then( function(file){
  ...
  function concatenate(){
    ...
    for( let i = 1; i < 7; i++ ){
      ...
      <div class="date-temp">
        <div class="temp">${newObj.days[i].temp}</div>
  ...
  <main>
    <div class="image-block">
      ...
      <div class="weather-image">
        <img src="images/${newObj.currentConditions.icon}.svg" alt="">
    ...
    <div class="weather-right-hand-side">
      ...
      <div class="middle-block">
        <div class="temp-data">${newObj.currentConditions.temp}°</div>
        <div class="temp-icon"><i class="fa-solid fa-temperature-three-quarters"></i></div>
      </div>
      <div class="down-block">
        <p>Humidity <span class="humidity-data" >${newObj.currentConditions.humidity}%</span></p>
